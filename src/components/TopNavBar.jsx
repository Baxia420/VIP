...
export default function TopNavBar({ breadcrumbs = [] }) {
  return (
    <header className="bg-surface border-b border-outline-variant flex justify-between items-center w-full px-base md:px-margin-desktop h-16 z-50 sticky top-0">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="w-8 h-8 rounded-full overflow-hidden border border-outline-variant">
          <img 
            ...
            src="https://lh3.googleusercontent.com/aida-public/AB6AXuCxagNABC5cQKSUfttqXxWuKOUihfncHJPKbZKSIrqjVGA29PDYEt4JyNC7lm02N9s06qd9VdV1KI3dxJ11u84PwNZMGtfMkrwhDapfWMwxixdiDbADbaEktry-0dWBZr-tGf8X4yKTmnqV3PybxRBaHmjN10_KtMNbLXdmIdDzUEEldOjrbKQD-6FYMUfv3cTMNkVvUWKLHelRiz5A85S1_9RQ8-E5U6Gz-e1TWY3sjWi6jDLJDoQA_a1mKa15WkGtl_FwhRQfftKs" 
          />
        </div>
      </div>
    </header>
